...
def get_expected_list_film(films: List[Dict[str, Any]],
    ...
    expected_list_film = [
        ...
        if ((filter_by_actor_id is None or filter_by_actor_id in [_["id"] for _ in film["actors"]]) and
            (filter_by_writer_id is None or filter_by_writer_id in [_["id"] for _ in film["writers"]]) and
            (filter_by_director_id is None or filter_by_director_id in [_["id"] for _ in film["directors"]]))
    ]
